const StartSection = () => {
  return (
    <section className="py-16 bg-white relative before:absolute before:left-0 before:top-0 before:h-full before:w-full before:bg-[url('/backgrounds/straight-lines.svg')] before:bg-contain before:bg-repeat before:opacity-30">
